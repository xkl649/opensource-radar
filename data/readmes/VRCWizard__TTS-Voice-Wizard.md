...
<a href="https://github.com/VRCWizard/TTS-Voice-Wizard/releases/download/v1.7.7.8/TTSVoiceWizard-v1.7.7.8-x64.zip"><img src="https://custom-icon-badges.demolab.com/badge/-Download-F25278?style=for-the-badge&logo=download&logoColor=white"></a> <br />
...
Thanks to [babo4d](https://github.com/babo4d) TTS Voice Wizard also can be installed via [scoop](https://scoop.sh/) with the following commands: <br />
- ``scoop bucket add extras ``<br />
- ``scoop install extras/tts-voice-wizard``<br />
